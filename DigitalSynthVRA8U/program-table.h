...
const uint8_t g_preset_table_OSC_1_WAVE     [] = {0  , 0  , 0  , 127, 127, 96 , 0  , 0  };
const uint8_t g_preset_table_OSC_1_SHAPE    [] = {64 , 64 , 64 , 64 , 64 , 64 , 64 , 64 };

const uint8_t g_preset_table_MIXER_SUB_OSC  [] = {127, 127, 127, 127, 127, 0  , 0  , 0  };

const uint8_t g_preset_table_OSC_2_WAVE     [] = {0  , 0  , 0  , 0  , 127, 0  , 0  , 0  };
const uint8_t g_preset_table_OSC_2_COARSE   [] = {71 , 71 , 64 , 76 , 64 , 64 , 64 , 64 };
const uint8_t g_preset_table_OSC_2_FINE     [] = {72 , 72 , 72 , 72 , 72 , 72 , 72 , 64 };
const uint8_t g_preset_table_MIXER_OSC_MIX  [] = {64 , 64 , 64 , 64 , 64 , 64 , 64 , 0  };

const uint8_t g_preset_table_FILTER_CUTOFF  [] = {112, 112, 4  , 124, 112, 112, 127, 127};
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 64 , 64 , 64 , 64 , 0  , 0  };
const uint8_t g_preset_table_FILTER_EG_AMT  [] = {64 , 64 , 124, 4  , 64 , 64 , 64 , 64 };
const uint8_t g_preset_table_FILTER_KEY_TRK [] = {127, 127, 127, 127, 127, 127, 127, 127};

const uint8_t g_preset_table_EG_ATTACK      [] = {0  , 0  , 64 , 96 , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_EG_DECAY       [] = {127, 127, 96 , 96 , 96 , 127, 127, 127};
const uint8_t g_preset_table_EG_SUSTAIN     [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_EG_RELEASE     [] = {0  , 0  , 0  , 0  , 96 , 0  , 0  , 0  };

const uint8_t g_preset_table_EG_OSC_AMT     [] = {64 , 64 , 64 , 64 , 64 , 64 , 64 , 64 };
const uint8_t g_preset_table_EG_OSC_DST     [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_VOICE_MODE     [] = {127, 0  , 0  , 0  , 64 , 127, 0  , 127};
const uint8_t g_preset_table_PORTAMENTO     [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  };

const uint8_t g_preset_table_LFO_WAVE       [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_LFO_RATE       [] = {96 , 96 , 96 , 96 , 96 , 64 , 96 , 96 };
...
const uint8_t g_preset_table_AMP_DECAY      [] = {127, 127, 127, 127, 96 , 127, 127, 127};
const uint8_t g_preset_table_AMP_SUSTAIN    [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_AMP_RELEASE    [] = {0  , 0  , 0  , 0  , 96 , 0  , 0  , 0  };
