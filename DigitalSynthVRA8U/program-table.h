...
const uint8_t g_preset_table_OSC_2_COARSE   [] = {71 , 64 , 64 , 64 , 71 , 64 , 64 , 64 };
const uint8_t g_preset_table_OSC_2_FINE     [] = {68 , 72 , 72 , 72 , 68 , 64 , 72 , 64 };
const uint8_t g_preset_table_MIXER_OSC_MIX  [] = {64 , 64 , 64 , 64 , 64 , 0  , 64 , 0  };

const uint8_t g_preset_table_FILTER_CUTOFF  [] = {112, 4  , 124, 76 , 112, 127, 127, 127};
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 32 , 64 , 64 , 0  , 0  , 0  };
...
const uint8_t g_preset_table_VOICE_MODE     [] = {127, 0  , 0  , 64 , 0  , 127, 0  , 127};
...
const uint8_t g_preset_table_LFO_DEPTH      [] = {8  , 8  , 8  , 8  , 8  , 0  , 8  , 0  };
const uint8_t g_preset_table_LFO_FADE_TIME  [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  };

const uint8_t g_preset_table_LFO_OSC_AMT    [] = {65 , 65 , 65 , 65 , 65 , 64 , 65 , 64 };
...
const uint8_t g_preset_table_CHORUS_MODE    [] = {127, 127, 127, 127, 127, 0  , 127, 0  };
const uint8_t g_preset_table_CHORUS_RATE    [] = {32 , 32 , 48 , 48 , 32 , 32 , 32 , 32 };
