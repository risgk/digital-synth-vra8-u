...
const uint8_t g_preset_table_OSC_2_WAVE     [] = {0  , 0  , 0  , 127, 0  , 64 , 0  , 0  };
const uint8_t g_preset_table_OSC_2_COARSE   [] = {71 , 64 , 64 , 64 , 71 , 52 , 64 , 64 };
...
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 32 , 64 , 64 , 32 , 0  , 0  };
...
const uint8_t g_preset_table_CHORUS_RATE    [] = {32 , 32 , 48 , 48 , 32 , 48 , 32 , 32 };
