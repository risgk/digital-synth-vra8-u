...
const uint8_t g_preset_table_FILTER_CUTOFF  [] = {112, 112, 4  , 124, 4  , 112, 127, 127};
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 32 , 32 , 32 , 32 , 0  , 0  };
const uint8_t g_preset_table_FILTER_EG_AMT  [] = {64 , 64 , 124, 4  , 124, 64 , 64 , 64 };
